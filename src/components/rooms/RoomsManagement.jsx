    ...
    <Row className="mb-4">
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {selectedCabana ? "Editar Habitación" : "Agregar Habitación"}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
                ...
                <Col>
                  <Form.Group className="mt-3">
                    ...
                    <div className="d-flex mb-3">
                      ...
                      />
                       <Button onClick={handleAddNewComodidad} variant="outline-primary">
        ...
        >
          ...
          <Modal.Body className="p-0">
            <Row className="g-0">
              ...
              <Col md={6}>
                <div className="p-4">
                  <h5 className="card-title mb-3">Detalles de la habitación</h5>
