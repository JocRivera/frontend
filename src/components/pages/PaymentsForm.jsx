...
const PaymentsForm = ({ payments, onAdd, onDelete }) => {
  ...
  const handleAdd = () => {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      setAlert({
        type: "danger",
        message: "Por favor, corrija los errores en el formulario de pagos.",
      });
    } else {
      setErrors({});
      onAdd(payment);
    ...
    <div className="mb-3">
          ...
          {payments.map((pay) => (
            <tr key={pay.id}>
              ...
              <td>
                {pay.receipt ? (
                  <a
                    href={URL.createObjectURL(pay.receipt)}
                    target="_blank"
      ...
      <div className="d-flex justify-content-between">
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control type="file" name="receipt" onChange={handleChange} />
        </Form.Group>
      </div>
