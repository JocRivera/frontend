    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            case 'name':
                ...
                break;
            case 'age':
                if (value && (isNaN(value) || value < 0)) errorMsg = 'La edad debe ser un número positivo.';
                break;
            case 'typeOfDocument':
                ...
                <Row>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            />
                            <Form.Control.Feedback type="invalid">{errorMessages.name}</Form.Control.Feedback>
                        </Form.Group>
                    </Col>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                ...
                <Row>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control.Feedback type="invalid">{errorMessages.typeOfDocument}</Form.Control.Feedback>
                        </Form.Group>
                    </Col>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            />
                            <Form.Control.Feedback type="invalid">{errorMessages.documentNumber}</Form.Control.Feedback>
                        </Form.Group>
                    </Col>
                </Row>
                <Row>
                    <Col md={6}>
                        <Form.Group className="mb-3">
                            ...
                            />
                            <Form.Control.Feedback type="invalid">{errorMessages.birthDate}</Form.Control.Feedback>
                        </Form.Group>
                    </Col>
                </Row>
