...
const PlanManagement = () => {
    ...
    return (
        <div className="container mt-5">
                    ...
                    <Col md={4} key={plan.id} className="mb-4">
                        <Card>
                            <Card.Body className="d-flex flex-column justify-content-between">
                                <Card.Title className="text-center text-uppercase">{plan.name}</Card.Title>
                                {plan.image && (
                                    <div className="text-center mb-3">
                                        <img src={plan.image} alt={plan.name} style={{ maxWidth: '100%', height: '200px', objectFit: 'cover' }} />
                                    </div>
                                )}
                                <div>
                                    <Card.Text><strong>Descripción:</strong> {plan.description}</Card.Text>
                                    <Card.Text><strong>Fecha de Inicio:</strong> {plan.startDate}</Card.Text>
                                    <Card.Text><strong>Fecha Fin:</strong> {plan.endDate}</Card.Text>
                                    <Card.Text><strong>Precio:</strong> {plan.price}</Card.Text>
                                    <Card.Text><strong>Precio de Venta:</strong> {plan.salePrice}</Card.Text>
                                    <Card.Text><strong>Capacidad:</strong> {plan.capacity}</Card.Text>
                                    <Card.Text><strong>Estado:</strong> {plan.status}</Card.Text>
                                </div>
                                ...
                                <div className="d-flex justify-content-between mt-2">
                                    ...
                                    <Button variant="warning" className="btn-lg" onClick={() => {
                                        setEditPlan(plan);
                                        setShowEditModal(true);
                                    }}>
                                        <FaEdit className="custom-icon" />
                                    </Button>
                                    <Button variant="danger" className="btn-lg" onClick={() => handleDelete(plan)}>
                    ...
                    <Form onSubmit={handleSubmit}>
                        <Row>
                            ...
                            <Col md={6}>
                                <div className="d-flex flex-column align-items-center mb-3">
                                    <div className="mb-2" style={{ width: '100%', height: '200px', border: '1px solid #ddd' }}>
                                        {newPlan.image ? (
                                            <img src={newPlan.image} alt="Imagen" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        ) : (
                                            <div className="d-flex justify-content-center align-items-center h-100">No hay imagen</div>
                                        )}
                                    </div>
                        ...
                        <Row>
                            <Col md={6}>
                                ...
                                <Button variant="primary" onClick={() => setShowServicesModal(true)}>Añadir Servicio</Button>
                            </Col>
                            <Col md={6}>
                                <Table bordered>
                                    <thead>
                                ...
                                <Button variant="primary" onClick={() => setShowAccommodationsModal(true)}>Añadir Alojamiento</Button>
                            </Col>
                        </Row>
                        <br />
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <div className="d-flex flex-column align-items-center mb-3">
                                    <div className="mb-2" style={{ width: '100%', height: '200px', border: '1px solid #ddd' }}>
                                        {editPlan.image ? (
                                            <img src={editPlan.image} alt="Imagen" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                        ) : (
                                            <div className="d-flex justify-content-center align-items-center h-100">No hay imagen</div>
                                        )}
                                    </div>
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <div className="d-flex flex-column align-items-center mb-3">
                                <div className="mb-2" style={{ width: '100%', height: '200px', border: '1px solid #ddd' }}>
                                    {detailsPlan.image ? (
                                        <img src={detailsPlan.image} alt="Imagen" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    ) : (
                    ...
                    <Row>
                        <Col>
                            ...
                            <Table striped bordered hover className="mt-2">
                                ...
                                <tbody>
                                    {detailsPlan.services && detailsPlan.services.map((service, index) => (
                                        <tr key={index}>
                                            <td>{service.name}</td>
                                            <td>{service.quantity}</td>
                                            <td>{service.price}</td>
                        ...
                        <Col>
                            ...
                            <Table striped bordered hover className="mt-2">
                                ...
                                <tbody>
                                    {detailsPlan.accommodations && detailsPlan.accommodations.map((accommodation, index) => (
                                        <tr key={index}>
                                            <td>{accommodation.name}</td>
                                            <td>{accommodation.type}</td>
                                            <td>{accommodation.price}</td>
            ...
            <Modal show={showAccommodationsModal} onHide={() => setShowAccommodationsModal(false)} size="lg">
                <Modal.Header closeButton>
