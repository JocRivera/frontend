...
const ClientManagement = () => {
  ...
  const validate = (values) => {
    ...
    if (!values.Identification)
      errors.Identification = "Identification es requerido";
        ...
        <Modal.Body>
          {currentClient ? (
            <div>
              ...
              <p>
                <strong>Identification:</strong> {currentClient.Identification}
              </p>
              <p>
                <strong>PhoneNumber:</strong> {currentClient.PhoneNumber}
              </p>
              <p>
                <strong>Address:</strong> {currentClient.Address}
              </p>
              <p>
                <strong>EPS:</strong> {currentClient.EPS}
              </p>
              <p>
